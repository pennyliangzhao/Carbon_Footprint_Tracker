...
//        }
    ...
    public String getData() {
        ...
        String[] columns = {myDbHelper.UID, myDbHelper.NAME, myDbHelper.MyPASSWORD, myDbHelper.TRAVEL_POINTS};
...
//    }
    ...
    static class myDbHelper extends SQLiteOpenHelper {
        ...
        static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME +
                " (" + UID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + NAME + " VARCHAR(255) ," + MyPASSWORD + " VARCHAR(225) ," + TRAVEL_POINTS + " INTEGER," + FOOD_POINTS + " INTEGER ," + SHOP_POINTS + " INTEGER ," + ACTION_POINTS + "INTEGER" + ");";
